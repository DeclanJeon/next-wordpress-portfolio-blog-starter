...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    title: "PonsWarp",
    category: "P2P/Realtime",
    status: "Prototype / infra check needed",
    year: "2026",
    ...
    proofNotes: "캡처 당시 signaling server 연결 실패 문구가 관찰되어 상태를 숨기지 않는다.",
    featured: true,
  },
  {
...
export const signatureSystems = [
  ...
  {
    title: "문서를 흐름으로",
    body: "DocuFlow와 PDF마스터는 한국 문서 업무의 변환·마스킹·OCR 반복을 한 흐름으로 묶는다.",
    projectSlug: "document-automation-suite",
  },
  {
    title: "파일을 직접 전송으로",
  ...
  {
    title: "도메인을 해석형 AI로",
    body: "Ruminate, 명경, Bible Companion은 단정 대신 문맥과 선택 가능한 조언을 설계한다.",
    projectSlug: "ruminate-fatemirror",
  },
]
...
export const writingCaseStudies = [
  ...
  "PDF마스터와 DocuFlow: 한국 문서 업무를 한 흐름으로 묶기",
  "Ruminate와 명경: 도메인 언어가 AI UX를 바꾸는 지점",
  "YouTube-to-MD: 영상 자료를 다시 쓸 수 있는 문서로 바꾸기",
]
