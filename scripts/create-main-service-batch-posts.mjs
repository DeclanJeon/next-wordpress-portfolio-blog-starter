...
function writeCover(post, index) {
  ...
  <text x="72" y="96" font-size="24" fill="rgba(255,255,255,0.72)" font-family="Inter, Arial, sans-serif">Pons Field Notes · Main Services ${String(index).padStart(2, '0')}</text>
